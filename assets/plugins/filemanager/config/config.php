...
$config = array(
	...
	|
	*/
	'base_url' => $site = ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'],
	...
	*/
	...
	'access_keys' => array(!isset($_GET['akey']) ? '' : $_GET['akey'] ),
	...
	*/
	...
	'ext_file'                                => array( 'doc', 'docx', 'pdf', 'ppt', 'pptx'), //Files
