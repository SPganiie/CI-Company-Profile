        ...
        <div class="card" id="b_content">
            ...
            <div class="body table-responsive">
                ...
                <?php if (!empty($list)) : ?>
                            ...
                            $post = id_to_name('post', 'id_post', $key->id_post, 'judul_seo_post');
                            $tgl = substr($key->waktu_komentar, 0, 10); $jam = substr($key->waktu_komentar, 10);
							if($i<2) 
								{
							?>
					<div style="clear:both">Judul Artikel:<br><h4><a target="_blank" href="<?php echo base_url().'post/detail_post/'.$post ?>">
